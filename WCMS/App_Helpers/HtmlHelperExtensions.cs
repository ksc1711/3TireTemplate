...
namespace WCMS.Web
{
	public static class HtmlHelperExtensions
	{
		...
		/// <returns>A HtmlString cotaining the given attribute value; otherwise an empty string.</returns>
		...
		/// <summary>
		/// Retrieves a non-HTML encoded string containing the assembly version and the application copyright as a formatted string.
		...
		{
			var copyright = String.Format("{0} &copy; {1} {2}", helper.AssemblyVersion(), DateTime.Now.Year, Settings.Company).Trim();
